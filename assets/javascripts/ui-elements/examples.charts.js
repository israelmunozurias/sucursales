	...
	(function() {
		var target = $('#gaugeBasic'),
			opts = $.extend(true, {}, {
				...
				colorStart: '#44aed6', // Colors
				colorStop: '#44aed6', // just experiment with them
